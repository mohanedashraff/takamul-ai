      ...
      <div className="flex flex-col flex-1 overflow-hidden pt-16 md:pt-20">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-5xl mx-auto px-4 py-6 space-y-6">
            ...
            {/* ── Person image upload (centered, ~300px tall) ── */}
            ...
            <div className="flex justify-center">
              <div className="flex items-center bg-white/6 border border-white/10 rounded-xl p-1 gap-1">
                ...
                <button onClick={resetClothes}
                  className={cn(
                    "w-9 h-9 rounded-xl border transition-all flex items-center justify-center mr-1",
                    totalSelected > 0
            ...
            <AnimatePresence initial={false}>
              {totalSelected > 0 && (
                <motion.div
                  ...
                  className="overflow-hidden">
                  <div className="rounded-2xl bg-black/30 border border-white/8">
            ...
            <div className="sticky bottom-4 z-10">
              <div className="rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-5 py-3.5 shadow-2xl">
