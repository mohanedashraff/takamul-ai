...
const VIDEO_MODELS: ToolInputOption[] = [
  ...
  { value: "veo-3-1-preview",    label: "Google Veo 3.1"     },
  { value: "minimax-2.3",        label: "Minimax Hailuo 2.3" },
...
const TRANSITIONS_STYLES: ToolInputOption[] = [
  ...
  { value: "air",        label: "Air Bending"       },
  { value: "water",      label: "Water Bending"     },
  { value: "earth",      label: "Earth Wave"        },
  { value: "fire",       label: "Fire Transition"   },
  { value: "melt",       label: "Melt Transition"   },
  { value: "smoke",      label: "Smoke Transition"  },
  { value: "splash",     label: "Splash Transition" },
  { value: "cotton",     label: "Cotton Cloud"      },
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        id: "sceneMode",
        type: "toggle",
        label: "خلفية من فيديو الحركة",
        hint: "تشغيل = خلفية الفيديو المصدر / إيقاف = خلفية الصورة",
        defaultValue: false,
      },
    ],
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        placeholder: "اكتب النص الذي تريد أن يقوله الشخص...",
        required: true,
      },
      {
        id: "scene",
        type: "prompt",
        label: "وصف المشهد (اختياري)",
        placeholder: "صف الخلفية والجو العام للمشهد...",
      },
      {
        id: "model",
        type: "select",
