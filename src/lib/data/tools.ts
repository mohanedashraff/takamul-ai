...
export const IMAGE_TOOLS: Tool[] = [
...

  {
    ...
    inputs: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "everyman",   label: "إنسان عادي (Everyman)" },
          { value: "innocent",   label: "بريء (Innocent)"       },
          { value: "explorer",   label: "مستكشف (Explorer)"     },
          { value: "ruler",      label: "حاكم (Ruler)"          },
          { value: "creator",    label: "مبدع (Creator)"        },
          { value: "rebel",      label: "متمرد (Rebel)"         },
          { value: "lover",      label: "محب (Lover)"           },
        ],
        defaultValue: "hero",
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          { value: "lean",       label: "رشيق"      },
          { value: "athletic",   label: "رياضي"     },
          { value: "muscular",   label: "عضلي"      },
          { value: "curvy",      label: "ممتلئ"     },
          { value: "heavy",      label: "ضخم"       },
        ],
    ...
    customRunner: {
      ...
      // prompt from the 8 fields and submits through nano-banana-pro
    ...
    inputs: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "everyman",   label: "عادي (Everyman)"      },
          { value: "innocent",   label: "بريء (Innocent)"      },
          { value: "explorer",   label: "مستكشف (Explorer)"    },
          { value: "ruler",      label: "حاكم (Ruler)"         },
          { value: "creator",    label: "مبدع (Creator)"       },
          { value: "rebel",      label: "متمرّد (Rebel)"       },
          { value: "lover",      label: "مُحبّ (Lover)"        },
        ],
      ...
      },
      {
        ...
        placeholder: "مثال: شعر أسود طويل، أشقر قصير، حليق…",
      },
      {
        id: "ethnicity_hint",
        type: "prompt",
        label: "العِرق / المنطقة (اختياري)",
        placeholder: "مثال: خليجي، شرق آسيوي، شمال إفريقي، جنوب أوروبا",
      },
      {
        id: "num_images",
        type: "counter",
