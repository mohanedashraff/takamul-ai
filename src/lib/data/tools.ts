...
export const STYLE_CATEGORIES = [
  { key: "all",       label: "الكل"                },
  { key: "new",       label: "جديد ✨"             },
  { key: "tiktok",    label: "TikTok Core"         },
  { key: "instagram", label: "Instagram Aesthetics"},
  { key: "camera",    label: "Camera Presets"      },
  { key: "beauty",    label: "Beauty"              },
  { key: "mood",      label: "Mood"                },
  { key: "surreal",   label: "Surreal"             },
  { key: "graphic",   label: "Graphic Art"         },
] as const;

const IMAGE_STYLES: ToolInputOption[] = [
  // ── No specific category (General) ──────────────────────────────────────────
  { value: "general",           label: "General",              image: CDN + "671935ec-51a6-4f9d-9cb4-39661b9a9814.jpg"  },
  { value: "tokyo_streetstyle", label: "Tokyo Streetstyle",    image: CDN + "b8665543-a419-4fda-a8d0-b10f07b8c03d.jpg"  },
  { value: "elevator_mirror",   label: "Elevator Mirror",      image: CDN + "0139a8e4-eb76-474a-a13c-d764d38674d1.jpg"  },
  { value: "ring_selfie",       label: "Ring Selfie",          image: CDN + "d5d6f14d-9ba1-4f29-96d9-792280f50782.jpg"  },
  { value: "gorpcore",          label: "Gorpcore",             image: CDN + "fbbfa936-7e5e-44f4-ac9c-774b38967130.jpg"  },
  { value: "half_selfie",       label: "0.5 Selfie",           image: CDN + "add67dde-7dbf-4565-93e9-a9bb121e03b9.jpg"  },
  { value: "half_outfit",       label: "0.5 Outfit",           image: CDN + "d014f6a2-792e-429b-b47a-33352ed95e2d.jpg"  },
  { value: "medieval",          label: "Medieval",             image: CDN + "6d384dd7-f756-41de-9628-06c6cb204423.jpg"  },
  { value: "japandi",           label: "Japandi",              image: CDN + "c63129ae-e4db-4bdf-9617-f7201f4a4cd1.jpg"  },
  { value: "coquette_core",     label: "Coquette Core",        image: CDN + "9ce0b7cb-2252-4047-8c9a-291a90395e66.jpg"  },
  { value: "quiet_luxury",      label: "Quiet Luxury",         image: CDN + "af2a00ab-3f9f-451b-8c0b-4abc81adb12a.webp" },
  { value: "hairclips",         label: "HairClips",            image: CDN + "35a6bbaa-4332-4537-8fce-28012da558be.jpg"  },
  { value: "505room",           label: "505 Room",             image: CDN + "293ed3aa-0d8e-4073-839a-d1698eafdf85.jpg"  },
  { value: "eating_food",       label: "Eating Food",          image: CDN + "d58fc1ab-f332-4e9b-bdd3-257164e92930.jpg"  },
  { value: "tumblr",            label: "Tumblr",               image: CDN + "8d797478-cc70-47e1-9a35-242852667eb0.jpg"  },
  { value: "through_the_glass", label: "Through The Glass",    image: CDN + "c6ffc0df-5487-417b-82d9-2ec54d2aa122.jpg"  },
  { value: "vintage_photobooth",label: "Vintage PhotoBooth",   image: CDN + "e41faf36-e634-485d-be55-edcce8099043.jpg"  },
  { value: "geominimal",        label: "Geominimal",           image: CDN + "670dae78-6481-4aab-b986-5060b1ae43ed.webp" },
  { value: "selfcare",          label: "Selfcare",             image: CDN + "6a5baf93-e0dc-4123-9f7b-868eab9b4e04.jpg"  },
  { value: "office_beach",      label: "Office Beach",         image: CDN + "71391c5d-1171-4b32-9c74-6e97413ab33c.jpg"  },
  { value: "swords_hill",       label: "Swords Hill",          image: CDN + "fe9aa7ca-01be-443f-be91-d55efb7691e7.jpg"  },
  { value: "amalfi_summer",     label: "Amalfi Summer",        image: CDN + "61d13bb8-fbe2-4816-8d2b-231e5ef68930.webp" },
  { value: "grunge",            label: "Grunge",               image: CDN + "dc742858-f56d-4fcc-9736-e7c2a3005b84.jpg"  },
  { value: "glazed_doll",       label: "Glazed Doll Skin",     image: CDN + "3c0eb808-90bf-4c84-b6fa-caae44265ef3.jpg"  },
  { value: "indie_sleaze",      label: "Indie Sleaze",         image: CDN + "3a5a91b6-330d-407e-8b55-c3900a95f0db.jpg"  },
  { value: "movie",             label: "Movie",                image: CDN + "a8417fb3-3801-4e00-b86f-57a55d59eacd.webp" },
  { value: "night_beach",       label: "Night Beach",          image: CDN + "270b4eb1-e9b1-4909-9f5e-50ce99697cc6.jpg"  },
  { value: "90s_editorial",     label: "90s Editorial",        image: CDN + "9cff0472-88b6-4ee2-a1e6-0976f79cdbe8.webp" },
  { value: "sitting_street",    label: "Sitting on the Street",image: CDN + "e4cce90c-943a-45be-a324-0a92fe0fcb9d.jpg"  },
  { value: "fashion_show",      label: "Fashion Show",         image: CDN + "c056f71c-31c6-48f5-8d4c-b13bab458ede.jpg"  },
  { value: "angel_wings",       label: "Angel Wings",          image: CDN + "2c8e708f-9fef-498c-bf66-bebfd8452705.webp" },
  { value: "pixelated_face",    label: "Pixelated Face",       image: CDN + "a6bf56b4-eb67-49e5-aa26-e2dd45882100.webp" },
  { value: "grillz_selfie",     label: "Grillz Selfie",        image: CDN + "f20194ec-4c8f-4ed5-9f23-152f7d09ecec.webp" },
  { value: "bleached_brows",    label: "Bleached Brows",       image: CDN + "aa99b83d-fe92-4542-8dab-b0c708d0cf30.jpg"  },
  { value: "giant_people",      label: "Giant People",         image: CDN + "b6552305-c29f-4f41-9252-49c5470b2b73.webp" },
  { value: "too_big",           label: "Help It's Too Big",    image: CDN + "77e056f6-89db-4c06-833a-91f143ad4612.webp" },
  { value: "birthday_mess",     label: "Birthday Mess",        image: CDN + "ea75ae9f-fa9a-4706-b1e0-8a01e01389cc.webp" },
  { value: "static_glow",       label: "Static Glow",          image: CDN + "443e1d53-353b-4459-b39e-56f91d141994.webp" },
  { value: "clouded_dream",     label: "Clouded Dream",        image: CDN + "9ce258c5-ae02-423d-86c7-15cd8073fb61.webp" },
  { value: "double_take",       label: "Double Take",          image: CDN + "f457ae4c-f11a-448d-b2ec-058835039e58.webp" },
  { value: "red_balloon",       label: "Red Balloon",          image: CDN + "504909f4-dad4-4f3a-b398-65e09e644200.webp" },
  { value: "tokyo_drift",       label: "Tokyo Drift",          image: CDN + "f3d48ef2-efd7-40fa-ae07-f19bc8795f54.webp" },
  { value: "rhyme_blues",       label: "Rhyme & Blues",        image: CDN + "d39c18e3-0b96-41ab-bcc7-4b6b29e953d5.webp" },
  { value: "bike_mafia",        label: "Bike Mafia",           image: CDN + "6e02af81-a6ab-4282-b432-da392a92bc31.webp" },
  { value: "dmv",               label: "DMV",                  image: CDN + "8feebd5a-7c6d-436a-8d38-bbeac7b65f34.webp" },
  { value: "sea_breeze",        label: "Sea Breeze",           image: CDN + "2f0a3204-759e-446c-bac9-ce83605b6833.webp" },
  { value: "its_french",        label: "It's French",          image: CDN + "5facd514-6d55-4d45-82a5-ff2e8d5feb99.webp" },
  { value: "fisheye_twin",      label: "Fish-Eye Twin",        image: CDN + "dbd126c8-0c0f-4bfc-bb10-76a2cf5a536c.webp" },
  { value: "hallway_noir",      label: "Hallway Noir",         image: CDN + "8f90d994-1b8d-4760-8afb-738da2975a50.webp" },
  { value: "burgundy_suit",     label: "Burgundy Suit",        image: CDN + "c23aa132-6ff5-4654-9db5-8de98013a0d7.webp" },
  { value: "nicotine_glow",     label: "Nicotine Glow",        image: CDN + "e1e573d1-530b-49e3-aea6-be773312a6a1.webp" },
  { value: "green_editorial",   label: "Green Editorial",      image: CDN + "17e1f0f2-fbb0-4380-b5c9-e3e179f1f3a9.webp" },
  { value: "afterparty_cam",    label: "Afterparty Cam",       image: CDN + "529d10c2-8394-44ac-bcea-e2760586e50e.webp" },
  { value: "2049",              label: "2049",                 image: CDN + "cb9644f9-8fe2-4b97-b248-0a232d8de01d.webp" },
  { value: "fireproof",         label: "Fireproof",            image: CDN + "a687cfa3-b2b4-4870-af9a-20ac2d1320ad.webp" },
  { value: "night_rider",       label: "Night Rider",          image: CDN + "4e5723ab-845d-43b2-b540-0202516e2e46.webp" },

  // ── New ─────────────────────────────────────────────────────────────────────
  { value: "flight_mode",       label: "Flight Mode",          image: CDN + "91490e65-80c2-42a0-bbec-971392a77462.webp", categories: ["new", "tiktok", "instagram"] },
  { value: "sunset_beach",      label: "Sunset Beach",         image: CDN + "71d9f310-f966-41ec-a009-a87167bcbebe.webp", categories: ["new", "tiktok", "instagram", "camera", "beauty"] },
  { value: "mt_fuji",           label: "Mt. Fuji",             image: CDN + "7bc1844f-33b1-4578-b25c-2c8ab373e350.webp", categories: ["new", "mood", "surreal"] },
  { value: "street_view",       label: "Street View",          image: CDN + "1c59f291-cf9d-45c1-92b0-53768f372d0e.webp", categories: ["new", "tiktok", "mood"] },
  { value: "gallery",           label: "Gallery",              image: CDN + "88d27015-a635-4c0f-bf47-19f7c280a659.webp", categories: ["new"] },
  { value: "crossing_street",   label: "Crossing the Street",  image: CDN + "9ef39e1b-693e-4560-89e0-6dfb670f42ea.webp", categories: ["new"] },
  { value: "library",           label: "Library",              image: CDN + "4d95d3b1-0db6-4125-a0d7-ba9ba770872f.webp", categories: ["new"] },
  { value: "escalator",         label: "Escalator",            image: CDN + "c23eef21-0f45-4e93-8818-1da4a3061d01.webp", categories: ["new"] },
  { value: "sunbathing",        label: "Sunbathing",           image: CDN + "97b9e378-ad9d-415e-b3f4-f4c8890dfb60.webp", categories: ["new"] },
  { value: "subway",            label: "Subway",               image: CDN + "af958840-be6d-4444-b441-22b7e1891f5d.webp", categories: ["new"] },

  // ── TikTok Core (extras not in New) ─────────────────────────────────────────
  { value: "digitalcam",        label: "DigitalCam",           image: CDN + "0e82377e-e3dd-48a8-94fd-04a4ed038be4.webp", categories: ["tiktok", "camera", "beauty"] },
  { value: "cctv",              label: "CCTV",                 image: CDN + "ed84e65b-1c57-4ce2-bef0-8e98c9e6667f.webp", categories: ["tiktok", "instagram", "camera", "beauty"] },
  { value: "bimbocore",         label: "Bimbocore",            image: CDN + "fb283ea7-2fdb-4b50-acd3-f38d83d2c93e.jpg",  categories: ["tiktok"] },
  { value: "y2k",               label: "Y2K",                  image: CDN + "75e73009-dd0c-4b9d-b0ef-93544b7e4491.jpg",  categories: ["tiktok"] },
  { value: "y2k_posters",       label: "Y2K Posters",          image: CDN + "a8d0899d-ec67-49a4-af7f-5fcf0a8f27be.webp", categories: ["tiktok"] },

  // ── Instagram Aesthetics (extras) ───────────────────────────────────────────
  { value: "iphone",            label: "iPhone",               image: CDN + "9627c330-e5e0-428d-8414-aeae83d57819.jpg",  categories: ["instagram", "camera", "beauty"] },
  { value: "realistic",         label: "Realistic",            image: CDN + "acf8f24d-f567-4b7a-bede-aa63cb7c90dd.jpg",  categories: ["instagram"] },

  // ── Camera Presets (extras) ──────────────────────────────────────────────────
  { value: "2000s_cam",         label: "2000s Cam",            image: CDN + "acc02fcd-ce68-4019-b517-089025455ed6.jpg",  categories: ["camera", "beauty"] },
  { value: "fisheye",           label: "Fisheye",              image: CDN + "cacbe40f-8551-481a-a8f3-57692fc4ba4d.webp", categories: ["camera"] },
  { value: "360_cam",           label: "360 Cam",              image: CDN + "a8951200-becf-4fa3-b41b-3a58e7ebcd72.jpg",  categories: ["camera", "beauty"] },

  // ── Beauty (extras) ──────────────────────────────────────────────────────────
  { value: "90s_grain",         label: "90s Grain",            image: CDN + "a5c20546-38eb-4d61-8eb2-5290908d55bc.jpg",  categories: ["beauty"] },
  { value: "babydoll_makeup",   label: "Babydoll MakeUp",      image: CDN + "1d334a76-18b8-4d7e-9f77-1f3b5623d872.jpg",  categories: ["beauty"] },
  { value: "object_makeup",     label: "Object Makeup",        image: CDN + "bb5c5572-693a-4b21-ba6e-329dc7da2af3.webp", categories: ["beauty"] },

  // ── Mood (extras) ────────────────────────────────────────────────────────────
  { value: "spotlight",         label: "Spotlight",            image: CDN + "47181b3d-429b-4f87-bb7c-2c5ca96da893.webp", categories: ["mood"] },
  { value: "sand",              label: "Sand",                 image: CDN + "665ca5a4-e1e7-4fed-8d53-01177ae0518d.jpg",  categories: ["mood"] },
  { value: "rainy_day",         label: "Rainy Day",            image: CDN + "dfa98f2e-9b22-4272-a030-a5296b3b9b6a.jpg",  categories: ["mood"] },
  { value: "foggy_morning",     label: "Foggy Morning",        image: CDN + "3cbfe1d2-421e-421a-b7bd-dbee471a1d65.jpg",  categories: ["mood"] },
  { value: "avant_garde",       label: "Avant-Garde",          image: CDN + "62cfc3fb-bb46-4977-9fbb-cee0b68504d4.jpg",  categories: ["mood"] },
  { value: "fairycore",         label: "Fairycore",            image: CDN + "a9f12667-0dd4-452e-b704-4ac8f29a69d9.webp", categories: ["mood"] },
  { value: "overexposed",       label: "Overexposed",          image: CDN + "e668934b-9b36-4263-86e0-cdd58f7c267b.jpg",  categories: ["mood"] },

  // ── Surreal (extras) ─────────────────────────────────────────────────────────
  { value: "nail_check",        label: "Nail Check",           image: CDN + "dc1274f0-b58d-4603-9f01-97337e512cac.jpg",  categories: ["surreal"] },
  { value: "giant_accessory",   label: "Giant Accessory",      image: CDN + "f66daa40-480f-49f1-90ed-6b2af23a4554.jpg",  categories: ["surreal"] },
  { value: "creatures",         label: "Creatures",            image: CDN + "ce4416fd-37a7-42fe-af0d-10167d2cfa0a.webp", categories: ["surreal"] },
  { value: "shoe_check",        label: "Shoe Check",           image: CDN + "55009845-16f0-43b0-a395-48c2bbe1f4d8.jpg",  categories: ["surreal"] },

  // ── Graphic Art ──────────────────────────────────────────────────────────────
  { value: "invertethereal",    label: "Invertethereal",       image: CDN + "5a70012c-02c4-45aa-934b-768587a2d0e4.jpg",  categories: ["graphic"] },
  { value: "mixed_media",       label: "Mixed Media",          image: CDN + "ca50ff8d-ed44-4043-b1ec-1c62247d4e44.webp", categories: ["graphic"] },
  { value: "paper_face",        label: "Paper Face",           image: CDN + "51362a07-60b0-4270-9125-03dea74ed03e.webp", categories: ["graphic"] },
  { value: "2000s_fashion",     label: "2000s Fashion",        image: CDN + "12160548-47c0-4652-9e2e-3fc9fb413d47.webp", categories: ["graphic"] },
  { value: "glitch",            label: "Glitch",               image: CDN + "bed53d7d-3061-4666-bcd6-2ad890387f97.webp", categories: ["graphic"] },
  { value: "long_legs",         label: "Long Legs",            image: CDN + "69a45320-c6ad-4242-8154-915121f42937.webp", categories: ["graphic"] },
  { value: "duplicate",         label: "Duplicate",            image: CDN + "0f7a191d-93ea-40a5-ad16-ca2b85fdd753.jpg",  categories: ["graphic"] },
  { value: "artwork",           label: "Artwork",              image: CDN + "40243714-8b1c-44bc-87f2-ef3aacc2daf9.webp", categories: ["graphic"] },
  { value: "graffiti",          label: "Graffiti",             image: CDN + "65d773e0-b947-4edc-982e-493ce1f04dc3.webp", categories: ["graphic"] },
];
