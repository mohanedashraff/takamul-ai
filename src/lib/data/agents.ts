...
export const AGENTS_LIST: Agent[] = [
  { 
    ...
    colorClass: "text-[#00bbf9]",
    shadowColor: "0, 187, 249",
    price: 299,
    rating: 4.8,
  ...
  { 
    ...
    colorClass: "text-[#fca311]",
    shadowColor: "252, 163, 17",
    price: 149,
    rating: 4.8,
    platform: "LangChain"
  },
