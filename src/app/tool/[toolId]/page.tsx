...
function WorkspaceInterface({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg-primary">
      ...
      <div className="flex flex-col flex-1 pt-16 md:pt-20 overflow-hidden">
        {/* ── Top bar ── */}
        <div className="h-14 shrink-0 flex items-center justify-between px-6 border-b border-white/5 bg-black/20 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <button
              ...
              {hasResult && (
                ...
                >
                  ...
                  <div className="flex gap-3 w-full">
                    <button className="flex-1 h-12 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 bg-white text-black hover:bg-gray-100 transition-colors shadow-xl">
